...
router.post('/password-reset/confirm', authRateLimit, controller.resetPassword);

// Protected routes (auth required)
router.get('/me', global.auth.token, controller.getMe);
router.put('/profile', global.auth.token, controller.updateProfile);
router.put('/change-password', global.auth.token, controller.changePassword);
