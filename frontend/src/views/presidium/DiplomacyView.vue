<template>
    <div class="h-screen flex flex-col bg-gray-50">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    ...
                    <div v-if="activeVote" class="space-y-6">
                        ...
                        <div v-if="activeVote.votingType === 'rollCall' && activeVote.rollCallOrder" 
                            ...
                            <div class="space-y-2">
                                <div v-for="(country, index) in activeVote.rollCallOrder" :key="country"
                                    :class="[
        ...
        <QuickVoteModal v-model="showCreateVoteModal" :session="currentSession"
            @voting-created="handleVotingCreated" />
    </div>
</template>
