<template>
    <div class="min-h-screen bg-gradient-mun">
        ...
        <aside :class="[
            ...
            <!-- Brand Header -->
            <div class="flex items-center justify-between h-16 px-6 border-b border-mun-gray-200 bg-gradient-to-r from-mun-blue-600 to-mun-blue-700">
                    ...
                    <div class="space-y-2">
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex items-center space-x-2">
                                <div :class="['w-2 h-2 rounded-full', systemHealth.api && systemHealth.database ? 'bg-green-500' : 'bg-red-500']"></div>
                                <span class="text-xs font-medium">{{ systemHealth.api && systemHealth.database ? 'Healthy' : 'Issues' }}</span>
                            </div>
                        </div>
