        ...
        <transition name="modal">
            <div v-if="modelValue" 
                ...
                <div class="bg-white rounded-2xl shadow-2xl w-full max-w-3xl max-h-[90vh] overflow-hidden"
                    ...
                    <!-- Header -->
                    <div class="flex items-center justify-between p-6 border-b border-mun-gray-200 bg-gradient-to-r from-un-blue to-mun-blue-600">
                                    ...
                                    <label v-for="reportType in reportTypes" :key="reportType.value"
                                        ...
                                        <div :class="[
                                            ...
                                            <div class="flex items-start space-x-3">
                                                ...
                                                />
                                                <div class="flex-1">
                                                    <h4 class="font-medium text-mun-gray-900">{{ reportType.label }}</h4>
                                                    <p class="text-sm text-mun-gray-600 mt-1">{{ reportType.description }}</p>
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div class="flex flex-wrap gap-2">
                                        <button v-for="quickRange in quickDateRanges" :key="quickRange.value"
                                            @click="setQuickDateRange(quickRange.value)"
                                            :class="[
                            ...
                            <div class="mun-card p-6">
                                ...
                                <div class="space-y-4">
                                    <label class="flex items-center space-x-3">
                                        <input 
                                            v-model="advancedOptions.includePersonalData"
                                            type="checkbox" 
                                            class="mun-checkbox"
                                        />
                                        <div>
                                            <div class="text-sm font-medium text-mun-gray-900">Include Personal Data</div>
                                            <div class="text-xs text-mun-gray-500">Email addresses, phone numbers, etc.</div>
                                        </div>
                                    </label>

                                    <label class="flex items-center space-x-3">
                                        <input 
                                            v-model="advancedOptions.includeStatistics"
                                            type="checkbox" 
                                            class="mun-checkbox"
                                        />
                                        <div>
                                            <div class="text-sm font-medium text-mun-gray-900">Include Statistics</div>
                                            <div class="text-xs text-mun-gray-500">Participation rates, voting patterns, etc.</div>
                                        </div>
                                    </label>

                                    <label class="flex items-center space-x-3">
                                        <input 
                                            v-model="advancedOptions.includeDocuments"
                                            type="checkbox" 
                                            class="mun-checkbox"
                                        />
                                        <div>
                                            <div class="text-sm font-medium text-mun-gray-900">Include Documents</div>
                                            <div class="text-xs text-mun-gray-500">Links to submitted documents and files</div>
                                        </div>
                                    </label>

                                    <label class="flex items-center space-x-3">
                                        <input 
                                            v-model="advancedOptions.separateSheets"
                                            type="checkbox" 
                                            class="mun-checkbox"
                                        />
                                        <div>
                                            <div class="text-sm font-medium text-mun-gray-900">Separate Sheets</div>
                                            <div class="text-xs text-mun-gray-500">Create separate sheets/tabs for different data types</div>
                                        </div>
                                    </label>
                                </div>
                            </div>
                            ...
                            <div v-if="selectedReportType" class="mun-card p-6">
                                ...
                                <div class="bg-mun-gray-50 rounded-lg p-4">
                                    ...
                                    <div class="text-sm text-mun-gray-600 space-y-1">
                                        ...
                                        <p v-if="hasFilters()"><strong>Filters Applied:</strong> {{ getFilterSummary() }}</p>
