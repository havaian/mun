                        ...
                        <div v-if="modal.actions || modal.showDefaultActions"
                            ...
                            <template v-else-if="modal.showDefaultActions">
                                <button @click="handleCancel(modal)" :disabled="modal.loading"
                                    class="px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-mun-blue transition-colors">
...
const getConfirmButtonClass = (type) => {
    const classMap = {
        ...
        question: 'bg-mun-blue hover:bg-mun-blue-dark focus:ring-mun-blue'
    }
...
const getDefaultActionClass = (variant) => {
    const classMap = {
        primary: 'bg-mun-blue text-white hover:bg-mun-blue-dark focus:ring-mun-blue',
        secondary: 'bg-gray-200 text-gray-900 hover:bg-gray-300 focus:ring-gray-500',
        success: 'bg-green-600 text-white hover:bg-green-700 focus:ring-green-500',
        danger: 'bg-red-600 text-white hover:bg-red-700 focus:ring-red-500',
        outline: 'bg-white text-gray-700 border border-gray-300 hover:bg-gray-50 focus:ring-mun-blue'
    }
